...
public final class DateUtil
{
    ...
    public static String addYear(Date src, int addYears)
    {
        DateFormat format = new SimpleDateFormat("yyyy");
        Calendar c = Calendar.getInstance();
        c.setTime(new Date());
        c.add(c.YEAR, addYears);// 属性很多也有月等等，可以操作各种时间日期
    ...
    public static String formatMonthDate(Date src)
    {
        return formatDate(src, "yyyy-MM");
    }
