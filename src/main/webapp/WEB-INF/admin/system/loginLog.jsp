...
$.extend($.fn.validatebox.defaults.rules, {    
	...
	$(function(){
			...
			$("#supplierTab").datagrid({
					url:getContextPath() +"/getLoginLogList",
					method: "post",
					pagination:true,
				    fit : true,
					fitColumns : false,
					...
					columns:[[
						...
						{field:'loginType',title:'登陆类型',align:'center',width:50,halign:'center',formatter:function(value,row,index){
							if('1' == value){
								return "登陆";
							} else if('2' == value){
								return "登出";
				        ...
				        {field:'loginResult',title:'登陆结果',align:'center',width:300,halign:'center'}
					]],
					toolbar:[]
	        });
